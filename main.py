...
# ctrl touches
ctrl_move_left = get_pygame_img(CreateImage(PSEUDO_WHITE, {"Move Left": "left"}, font_size=26))
ctrl_move_right = get_pygame_img(CreateImage(PSEUDO_WHITE, {"Move Right": "right"}, font_size=26))
w = WIDTH/8
